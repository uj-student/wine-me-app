...
class ReviewFragments(private val reviewObject: WineReviewsModel) : Fragment() {
    ...
    private fun populateCard(view: View) {
        ...
        val region2: TextView = view.findViewById(R.id.region2)
        ...
        tasterTwitterHandle.text = cardDetails(getString(R.string.taster_twitter_handle), reviewObject.taster_twitter_handle)
        price.text = cardDetails(getString(R.string.price), getWinePrice(reviewObject.price).toString())
        ...
        region2.text = cardDetails(getString(R.string.region_2), reviewObject.region_2)
        province.text = cardDetails(getString(R.string.province), reviewObject.province)
        country.text = cardDetails(getString(R.string.country), reviewObject.country)
